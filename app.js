(() => {
  ...
  function renderMetrics() {
    ...
    document.querySelector('#release-reason').textContent = `${urgent} critical/high findings remain open; 21 of 30 scenarios have not started.`;
  }
  ...
  function activeFilterText() {
    ...
    return parts.length ? parts.join(' · ') : 'Full KYC Reviewer record';
  }
  ...
  function openFinding(id, updateHash = true) {
    ...
    elements.dialogContent.innerHTML = `
      ...
      <section class="detail-section">
        ...
        <p>${escapeHtml(finding.evidenceStatus)} · 11 September KYC Reviewer campaign record. Private webapp <code>tests/e2e/kyc-reviewer/</code> scenario runs are the source of this sanitized consolidation. <a href="#coverage" id="dialog-coverage">View scenario coverage and provenance</a>.</p>
      ...
      <section class="detail-section">
        <h3>Lifecycle</h3>
        <div class="timeline">
          <div class="timeline-item done"><strong>Finding recorded</strong><small>${finding.scenario} · KYC Reviewer Chrome evidence run</small></div>
  ...
  function exportCsv() {
    ...
    link.download = 'kyc-reviewer-uat-interim-20260912.csv';
    link.click();
